...
class authorsControllers {
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.default.query('UPDATE name set ? WHERE author_id = ?', [req.body, id]);
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.default.query('DELETE FROM authors WHERE author_id = ?', [id]);
            res.json({ text: 'The author was eliminated ' });
        });
    }
}
